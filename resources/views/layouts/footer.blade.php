    ...
    <footer class="text-center text-lg-start text-white" style="background-color:#547ff7 ">
      <!-- Grid container -->
        ...
        <div class="row my-4">
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
            ...
            <div class="rounded-circle bg-white shadow-1-strong d-flex align-items-center justify-content-center mb-4 mx-auto" style="width: 150px; height: 150px;">
              <img src="{{asset("img/logo/Logo Seilo.png")}}" width="120" alt=""
                   loading="lazy" />
            </div>
  
            <p class="text-center">Enhancing The Education Through Industrial Experience.</p>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
            ...
            <ul class="list-unstyled">
              <li class="mb-2">
                <a href="/" class="text-white"><i class="fas fa-arrow-right pe-3"></i>Home</a>
              </li>
              <li class="mb-2">
                <a href="{{route('about')}}" class="text-white"><i class="fas fa-arrow-right pe-3"></i>About Us</a>
              </li>
              <li class="mb-2">
                <a href="{{route('blog.index')}}" class="text-white"><i class="fas fa-arrow-right pe-3"></i>Blog</a>
              </li>
              <li class="mb-2">
                <a href="#price" class="text-white"><i class="fas fa-arrow-right pe-3"></i>Price</a>
              </li>
            </ul>
          </div>
          <!--Grid column-->
