    ...
    <div class="container-fluid py-4">
        <div class="mx-3 mx-md-4">
            <div class="card card-body">
                ...
                <form role="form" action="{{route('admin.blog.store')}}" class="m-4" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group mb-3">
                        <label for="gambarInput">Pilih Gambar : </label>
                        <input name="gambar" type="file" class="form-control-file" id="gambarInput" aria-describedby="gambarHelp" accept="image/*">
